const steps = [
  { step: "01", title: "Post Requirement", body: "Share drawings, material details, deadline, quality needs, and site location." },
    ...
    <section className="bg-white py-14 sm:py-16 lg:py-20">
      <div className="page-shell grid gap-8">
        ...
        <div className="grid gap-4 lg:grid-cols-4">
          {steps.map((item) => (
            <div className="relative rounded-lg border border-line bg-canvas p-6 transition hover:-translate-y-1 hover:bg-white hover:shadow-soft" key={item.step}>
