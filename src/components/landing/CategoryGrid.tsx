      ...
      <div className="page-shell grid gap-10">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div className="max-w-2xl">
            <p className="text-sm font-black uppercase tracking-[0.18em] text-brand-gold">Industrial Categories</p>
            <h2 className="mt-3 text-3xl font-black sm:text-4xl">Find specialized vendors for every shop-floor requirement.</h2>
          </div>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {categories.map((category, index) => (
            ...
            >
              ...
              <p className="mt-2 text-xs text-slate-400">Post RFQ</p>
            </a>
          ))}
        </div>
      </div>
